...
# recently fixed in master, but it's not backported to python2 notebook
# so we fix it for ourselves.

sed -i 's/ip = "(%s or 127.0.0.1)" % socket.gethostname()/ip = "localhost"/' /usr/local/lib/python2.7/site-packages/notebook/notebookapp.py
